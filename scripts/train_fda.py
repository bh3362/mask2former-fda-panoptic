...
def setup(args):
    ...
    # FDA run: register the FDA-styled CARLA images (see scripts/fda/apply_fda.py).
    TRAIN, VAL = register_carla_panoptic(
        CARLA_DATASET_ROOT, "leftImg8bit_fda", "carla_final_panoptic_train", "carla_final_panoptic_val"
    )
    ...
    if not cfg.OUTPUT_DIR:
        cfg.OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "./output/train_fda")
